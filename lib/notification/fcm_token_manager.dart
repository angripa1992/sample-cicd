...
class FcmTokenManager {
  ...
  final DeviceInformationProvider _deviceInformationProvider;
  ...
  Future<Either<Failure,bool>> registerToken(String fcmToken) async{
    final String? deviceId = await _deviceInformationProvider.getDeviceId();
    final Map<String,dynamic> params = {};
    params['user_id'] = _appPreferences.getUser().userInfo.id;
    params['token'] = fcmToken;
    params['platform'] = _deviceInformationProvider.getPlatformName();
    params['app_type'] = 2;
