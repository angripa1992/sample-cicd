...
class PriceCalculator {
  ...
  static String formatPrice({
    ...
    if (code.toUpperCase() == 'IDR') {
      return NumberFormat.currency(locale: 'id', symbol: symbol, decimalDigits: 0).format(price);
    } else if (code.toUpperCase() == 'JPY') {
      return NumberFormat.currency(locale: 'ja', symbol: symbol, decimalDigits: 0).format(price);
    }
