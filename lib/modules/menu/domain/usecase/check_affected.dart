...
class CheckAffected extends UseCase<ModifierDisabledResponse,ModifierRequestModel>{
  final MenuRepository _repository;

  CheckAffected(this._repository);

  @override
  Future<Either<Failure, ModifierDisabledResponse>> call(ModifierRequestModel params) {
