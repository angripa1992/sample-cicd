...
class CheckAffected extends UseCase<AffectedModifierResponse, ModifierRequestModel> {
  final MenuRepository _repository;

  CheckAffected(this._repository);

  @override
  Future<Either<Failure, AffectedModifierResponse>> call(ModifierRequestModel params) {
